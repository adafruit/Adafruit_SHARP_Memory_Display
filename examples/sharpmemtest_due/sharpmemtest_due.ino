...
// pin 4 is set to hardware SPI SS pin, do not connect (hardware SPI has opposite SS polarity, so we need to use another SS pin)
#define SS 13

Adafruit_SharpMem display(0, 0, SS);
